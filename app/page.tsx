...
const logo = "https://raw.githubusercontent.com/gj-bots/assets-holder/main/file.jpg";
...
export default function IndexPage() {
  return(
	...
	<div className="col-span-full flex justify-center align-middle">
	    <Card className={"w-96 h-fit dark:text-white dark:border-2 dark:border-solid dark:border-slate-800 rounded"}>
	      <CardHeader>
		<CardTitle>
		  Project 
		...
		<CardDescription>
		  By <Link target="_blank" href="https://github.com/gj-bots" className="underline text-amber-400"><b>GjBots</b></Link>
		</CardDescription>
	      </CardHeader>
		  ...
		  {notifications.map((notification, index) => (
			...
			<p className="text-sm text-muted-foreground">
			  <Link href={notification.authorLink}>
			    <b className="text-amber-300 underline">{notification.author}</b>
			  </Link>
			</p>
		      </div>
		    </div>
